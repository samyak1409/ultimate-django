...
First, we need to get the content type object using:
Since `TaggedItem` table is not linked to any model, it can contain multiple models. I mean, tagged item can be a product and also a collection at the same time.
