...
What is `models.SlugField()` and how exactly does it work?  
Read: [`Gemini`](https://g.co/gemini/share/faf64a82a49d)
...
> Explains how to undo/revert migrations—by downgrading with `migrate`, and then either deleting migration files & code, or more cleanly using Git reset.
...
> Used Mockaroo to generate and import dummy data (CSV/SQL) into ~~MySQL~~ Postgres tables for testing.
