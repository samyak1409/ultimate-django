...
3. Add middleware: `"corsheaders.middleware.CorsMiddleware"` **at the top**. (See: [Order of Middlewares](https://github.com/samyak1409/ultimate-django/blob/main/Notes/Part%203/7.%20Preparing%20for%20Production.md#order-of-middlewares))
...
> - You use the `{% static 'store/styles.css' %}` tag in your templates to correctly load the namespaced files.
>
