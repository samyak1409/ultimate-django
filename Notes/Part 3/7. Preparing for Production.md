...
4. Move env-specific configs out of `common.py` to both `dev.py`, `prod.py`:
   ...
   - **Middlewares** → keep in common; dev: insert `DebugToolbar` at 0, append `Silky` (See: [Order of Middlewares](/Notes/Part%203/7.%20Preparing%20for%20Production.md#order-of-middlewares))
