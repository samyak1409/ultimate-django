...
- **Installation & Setup:**
  ...
  2. Add middleware (`'silk.middleware.SilkyMiddleware'`) (See: [Order of Middlewares](https://github.com/samyak1409/ultimate-django/blob/main/Notes/Part%203/7.%20Preparing%20for%20Production.md#order-of-middlewares))
