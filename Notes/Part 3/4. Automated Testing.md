...
- **Popular Python frameworks**
  ...
  <details>
  <summary>See key differences</summary>

  | Feature        | unittest                                           | pytest                                          |
  | -------------- | -------------------------------------------------- | ----------------------------------------------- |
  | Availability   | Built-in (standard library)                        | External library (requires installation)        |
  | Test Structure | Object-oriented (classes inheriting from TestCase) | Functional (plain functions) or object-oriented |
  | Assertions     | Specific assert methods (e.g., assertEqual)        | Plain assert statements                         |
  | Fixtures       | setUp, tearDown methods                            | Flexible and powerful fixture system            |
  | Readability    | More verbose                                       | More concise and Pythonic                       |
  | Plugins        | Limited                                            | Extensive plugin ecosystem                      |
  | Output         | Less detailed                                      | More detailed and informative                   |
...
- **Wouldn't this create a new user every time the test is ran?**
  ...
  Ref: [ChatGPT](https://chatgpt.com/share/68b36214-60c8-800a-8adf-f0ebc5830b17), [Gemini](https://g.co/gemini/share/510bcaf8e42a)
...
- Example: `create_collection` fixture.
  ...
  - This is a **closure** → function returning another function. (This concept exists in JavaScript as well.)
    ...
    Why do we need an inner function? → To be able to pass an arg (`title` in this case)!
